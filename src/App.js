...
function App() {
  ...
  const [messages, setMessages] = useState([
    { sender: "bot", text: "診断結果をお伝えします。関心が高い項目をクリックしてください。" },
  ]);
  const [userMessage, setUserMessage] = useState("");
  const [requestCount, setRequestCount] = useState(0); // submitToDify と submitToDify_2 をあわせたリクエスト数
    ...
    processMessage(message, buttonRegex, ([, dataMessage, buttonText]) => {
      ...
      return (
        <button
          ...
          style={{
            backgroundColor: isHighlightedButton ? "#C45C49" : "#1E899D", // 特定のボタンはゴールド
            color: "white", /* テキスト色 */
            ...
            display: "block", // ボタンのテキスト表示をブロック要素に
          }}
        >
          {buttonText}
        </button>
      ...
      element={
        <div className="chat-container">
          ...
          <div className="survey-link">
            チャットを終了するときは
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLSfUQShM52hGV_JpDdsxaflW-t03DNOIbqzM2F2UFxjw6JCzVQ/viewform?usp=dialog"
              target="_blank"
              rel="noopener noreferrer"
            >
              <b>利用者アンケート</b>
